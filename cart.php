...
if(isset($_SESSION["id"])){
	...
	if($count==0){
		...
		<input name="adjustBtn' . $item_id . '" type="submit" value="Atualizar" />
		...
		$cartTotal = "<div style='font-size:18px; margin-top:12px;' align='right'>Total a pagar : R$ ".$cartTotal." </div>";		
		if ($ltc > 12000){
			$ltc = "<div style='font-size:18px; margin-top:12px;' align='right'>LIMITE NÃO PERMITIDO PARA COMPRA </div>";	
		}else{
			if ($ltc >= 1000){
				($ltc = $ltc / 1000);
			$ltc = "<div style='font-size:18px; margin-top:12px;' align='right'>Total de litros : ".$ltc." </div>";		
				}else{$ltc = "<div style='font-size:18px; margin-top:12px;' align='right'>Total de Ml : ".$ltc." </div>";
			}
		}
	}
}
                ...
                <div style="margin:24px; text-align:left;">
                    ...
                    <table width="100%" border="2" cellspacing="0" cellpadding="6">
                        <tr>
                            ...
                            <td><strong>Produto Descrição</strong></td>
                            <td><strong>Valor Unitario</strong></td>
                            <td><strong>Quantidade Garrafas</strong></td>
                            <td><strong>Quantidade Lt/Ml</strong></td>
...
<?php echo $cartOutput; ?>
                    ...
                    <div class="esv_car"> 
						<a href="cart.php?cmd=emptycart">Clique aqui para esvazir seu carrinho</a>
					</div>
                    <div class="btn_fim" align="right">
					<a href="pdf.php" target="_blank">FINALIZAR PEDIDO</a>
					</div>
                </div>
                <br />
            </div>
