...
<div align="center" id="mainWrapper">
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="6">
      <tr>
        <td width="20%" align="right">NOME COMPLETO</td>
        <td width="80%"><label>
      ...
      <tr>
        <td width="20%" align="right">CONFIRME A SENHA</td>
        <td width="80%"><label>
          <input name="cpassword" type="password" id="cpassword" size="20" />
        </label></td>
      </tr>
	  <tr>
        <td align="right">PERGUNTA DE SEGURANÇA</td>
        <td><label>
          <select name="security" id="security">
          <option value=""></option>
          <option value="What is your school name?">QUAL O NOME DA SUA ESCOLA?</option>
          <option value="What is your mother's first maiden name?">QUAL O PRIMEIRO NOME DA SUA MÃE?</option>
          <option value="What is your favourite hobby?">QUAL SEU ESPORTE FAVORITO?</option>
          <option value="What is your nick name?">QUAL SEU APELIDO?</option>
          <option value="What is your pet name?">QUAL O NOME DO SEU ANIMAL DE ESTIMAÇÃO?</option>
          <option value="What is your favourite game?">QUAL SEU FILME FAVORITO?</option>
          </select>
        </label></td>
      </tr>       
      <tr>
        <td width="20%" align="right">RESPONDA</td>
        <td width="80%"><label>
      ...
      <tr>
        <td width="20%" align="right">CIDADE</td>
        <td width="80%"><label>
